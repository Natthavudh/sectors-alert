...
button.innerHTML = `
  ...
  data-v-edcc911a="" class="Action_icon"><svg data-v-edcc911a="" viewBox="0 0 19 13" fill="none"
    ...
    <path data-v-edcc911a=""
      ...
      fill="currentColor"></path>
  </svg></span><span data-v-edcc911a="" class="Action_label">Base</span>
  <!---->
  <!---->
  </button>
  `;
...
span.classList.add("material-icons-sp-icon-close");
...
span.addEventListener("click", closePanel);
...
async function productionCycles(planet, sector) {
  ...
  if (getSector[0]) {
    var sectorProgress1 = getSector[0].productionCyclesLeft;
  }
  if (getSector[1]) {
    var sectorProgress2 = getSector[1].productionCyclesLeft;
  }
  if (getSector[2]) {
